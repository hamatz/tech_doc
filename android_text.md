...
企画段階のサービスを分析しつつ、アプリケーションとしてリリースするまでの一連の作業を追体験しながら学ぶという本書のコンセプトを通して、読者の皆さんがAndroidアプリケーション開発におけるクリーンアーキテクチャとMVVMの実践方法を習得し、アプリケーションの設計と実装スキルを向上させる一助となれれば幸いです。また、本書が、アプリケーション開発の現場における品質と保守性の向上に寄与することを期待しています。
